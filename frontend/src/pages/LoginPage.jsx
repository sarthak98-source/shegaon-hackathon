...
export default function LoginPage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Invalid credentials. Try demo login below.')
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-brand-500 p-12 text-white">
        ...
        <div>
          ...
          <p className="text-orange-100 text-lg mb-8">Try products in AR, chat with sellers live, and buy with confidence.</p>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input name="password" type={showPw?'text':'password'} value={form.password} onChange={e => setForm(p => ({...p, password:e.target.value}))}
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full justify-center py-3 text-base disabled:opacity-60">
              {loading ? <div className="w-5 h-5 border-2 border-white/40 border-t-white rounded-full animate-spin"/> : <>Sign In <ArrowRight size={16}/></>}
            </button>
          </form>
          ...
          <div className="mt-6">
            <div className="relative mb-4">
              ...
              <div className="relative text-center"><span className="bg-gray-50 px-3 text-xs text-gray-500 font-medium">Quick Demo Login</span></div>
            </div>
